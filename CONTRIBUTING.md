...
1. use the search functionality [here](https://github.com/smangham/test_project/issues) to see if someone already filed the same issue;
...
1. [push](http://rogerdudler.github.io/git-guide/) your feature branch to (your fork of) the test_project repository on GitHub;
...
1. Wait until [PyPi publish workflow](https://github.com/smangham/test_project/actions/workflows/publish.yml) has completed
...
1. Wait until new release is also on Bioconda (https://anaconda.org/bioconda/test_project) via a automaticly created PR on [bioconda recipes repo](https://github.com/bioconda/bioconda-recipes/pulls?q=is%3Apr+is%3Aopen+test_project)
1. Test test_project from bioconda by manually running [Conda verify](https://github.com/smangham/test_project/actions/workflows/conda_verify.yml) workflow
-->
